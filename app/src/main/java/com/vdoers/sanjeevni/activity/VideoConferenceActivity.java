package com.vdoers.sanjeevni.activity;
...
import com.enablex.sanjeevni.R;
import com.vdoers.sanjeevni.adapter.HorizontalViewAdapter;
import com.vdoers.sanjeevni.model.HorizontalViewModel;
import com.vdoers.sanjeevni.model.UserModel;
import com.vdoers.sanjeevni.utilities.OnDragTouchListener;
...
public class VideoConferenceActivity extends AppCompatActivity implements EnxRoomObserver, EnxStreamObserver, View.OnClickListener, EnxReconnectObserver, EnxActiveTalkerViewObserver, EnxChairControlObserver {
    EnxRtc enxRtc;
    String token;
    String name;
...
//        super.onBackPressed();
    ...
    public void onFloorRequestReceived(JSONObject jsonObject) {
        try {
            enxRooms.grantFloor(jsonObject.getString("clientId"));
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
