...
import com.vdoers.sanjeevni.ApplicationController;
import com.enablex.sanjeevni.R;
import com.vdoers.sanjeevni.web_communication.WebCall;
import com.vdoers.sanjeevni.web_communication.WebConstants;
import com.vdoers.sanjeevni.web_communication.WebResponse;
...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener, WebResponse {
    ...
    private void validateRoomIDWebCall() {
        new WebCall(this, this, jsonObjectToSend(), WebConstants.validateRoomId + room_Id, WebConstants.validateRoomIdCode, true, false).execute();
    }
